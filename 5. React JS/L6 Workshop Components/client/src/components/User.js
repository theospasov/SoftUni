...
export default function User({ 
  _id, firstName, lastName, email, imageUrl, createdAt, phoneNumber, onInfoClick 
}){
    return(
        <tr>
              <td>
                <img src={imageUrl}
                  alt={`${firstName}'s profile image`} className="image" />
              </td>
              <td>{firstName}</td>
              <td>{lastName}</td>
              <td>{email}</td>
              <td>{phoneNumber}</td>
              <td>{formantDate(createdAt)}</td>
