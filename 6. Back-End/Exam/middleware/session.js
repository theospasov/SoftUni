...
module.exports = () => (req, res, next) => {
    ...
    if (token) {
        try {
            ...
            req.user = userData
            res.locals.email = userData.email // adding the username in the global context, so we may add it to the navigation in the layout and see the username when logged in and also see specific buttons (like registration when not logged in )
        } catch (error) {
