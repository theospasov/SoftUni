...
function solve() {
    ...
    addButton.addEventListener('click', (e) => {
        ...
        if(typeof modelInput == 'string' && modelInput.length > 0 && descriptionInput == 'string' && descriptionInput.length > 0 && typeof yearInput == 'number' && yearInput > 0 && typeof priceInput == 'number' && priceInput > 0) {
